...
export const EventCard = ({ event }: { event: Event }) => {
  ...
  return (
    ...
    //     </div>
    //   </div>
    <Link href={"events/asdasdasd"} prefetch={false}>
      <div
        onClick={() => onClick}
        className=" cursor-pointer relative flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg w-full"
      >
        ...
        <span className="text-slate-600 ml-1.5">5.0</span>
          ...
          <p className="text-slate-600 leading-normal font-light text-md">
            {event.description}
          </p>
        </div>
