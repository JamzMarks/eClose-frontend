...
export default function DateRangePickerWithInlineButtons() {
  ...
  return (
    <section className="bg-white text-black py-20 lg:py-[120px] dark:bg-dark">
                ...
                {isOpen && (
                  ...
                  >
                    ...
                    <div className="mt-5 flex justify-end space-x-2.5 border-t border-stroke p-5 dark:border-dark-3">
                      ...
                      <button
                        id="applyButton"
                        className="rounded-lg bg-primary px-5 py-2.5 text-base font-medium text-white hover:bg-amber-600"
                        onClick={handleApply}
                      >
                        Apply
                      </button>
